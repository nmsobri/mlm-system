...
class RegularUserAccountController extends BaseController
{
    ...
    public function index()
    {
        ...
        return View::make( 'regularuser.account.index',
    ...
    {
        return View::make( 'regularuser.account.payment' );
    }
    ...
    public function postPayment()
    {
        ...
        if ( $this->repository->savePayoutRequest( Auth::user()->id,
            Input::get( 'amount' ) ) )
        {
            return Redirect::to('/user/regular/account/payment')
