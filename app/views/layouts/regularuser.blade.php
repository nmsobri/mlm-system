...
@section('user.nav')
    ...
    <div id="user-nav">
        <ul class="btn-group">
            ...
            <li class="btn"><a title="" href="{{url('user/regular/logout')}}"><i class="fa fa-power-off"></i> <span class="text">Logout</span></a></li>
        </ul>
    </div>
...
@section('sidebar.nav')
    ...
    <div id="sidebar">
        ...
        <ul>
            <li><a href="{{url('user/regular/')}}"><i class="fa fa-home"></i> <span>Home</span></a></li>
            <li class="submenu">
                <a href="#"><i class="fa fa-users"></i> <span>User</span> <i class="arrow fa fa-chevron-right"></i></a>
                <ul style="display: none;">
                    <li><a href="{{url('user/regular/lists')}}">List User</a></li>
                    <li><a href="{{url('user/regular/create')}}">Create User</a></li>
                </ul>
            </li>
            <li><a href="{{url('user/regular/profile')}}"><i class="fa fa-user"></i> <span>Profile</span></a></li>
            <li><a href="{{url('user/regular/account')}}"><i class="fa fa-briefcase"></i> <span>Account</span></a></li>
        </ul>
