...
@section('user.nav')
    ...
    <div id="user-nav">
        <ul class="btn-group">
            ...
            <li class="btn"><a title="" href="{{url('admin/super/logout')}}"><i class="fa fa-power-off"></i> <span class="text">Logout</span></a></li>
        </ul>
    </div>
...
@section('sidebar.nav')
    ...
    <div id="sidebar">
        ...
        <ul>
            <li><a href="{{url('admin/super/')}}"><i class="fa fa-home"></i> <span>Home</span></a></li>
            <li class="submenu">
                <a href="#"><i class="fa fa-users"></i> <span>User</span> <i class="arrow fa fa-chevron-right"></i></a>
                <ul style="display: none;">
                    <li><a href="{{url('admin/super/lists')}}">List User</a></li>
                    <li><a href="{{url('admin/super/create')}}">Create User</a></li>
                </ul>
            </li>
            <li><a href="{{url('admin/super/profile')}}"><i class="fa fa-user"></i> <span>Profile</span></a></li>
            <li><a href="{{url('admin/super/transaction')}}"><i class="fa fa-bar-chart-o"></i> <span>Transaction</span></a></li>
        </ul>
