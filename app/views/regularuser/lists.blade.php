        ...
        <div class="col-xs-12">
            ...
            <div class="widget-box">
                ...
                <div class="widget-title">
                    ...
                    <h5>User List</h5>
                    <div class="report">
                        {{html_entity_decode(HTML::link('/user/regular/report/user/excel', '<i class="fa fa-file-excel-o fa-lg"></i>'))}}
                        {{html_entity_decode(HTML::link('/user/regular/report/user/pdf', '<i class="fa fa-file-pdf-o fa-lg"></i>'))}}
                    </div>
                </div>
                            ...
                            @foreach($users as $key =>$user)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{url('/user/regular/update', $user->id)}}">Edit</a>
                                        <a href="{{url('/user/regular/delete',$user->id)}}" onclick="return confirm('Are you sure? This will delete all downlines under this user. Proceed?')">Delete</a>
                                    </td>
                                </tr>
