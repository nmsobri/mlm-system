        ...
        <div class="col-xs-12">
            ...
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    ...
                    {{Form::open(['url'=>'/admin/super/create', 'class'=>'form-horizontal'])}}

                        <div class="form-group{{$errors->has('username') ? ' has-error' : ''}}">
                            {{Form::label('username','Username',['class'=>'col-sm-3 col-md-3 col-lg-2 control-label'])}}
                            <div class="col-sm-9 col-md-9 col-lg-10">
                                {{Form::text('username', $username,['readonly'=>true, 'class'=>'form-control input-sm'])}}
                        ...
                        <div class="form-group{{$errors->has('groups') ? ' has-error' : ''}}">
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-10">
                                {{Form::select('groups', [''=>'Please Select','regular_admin'=>'Regular Admin', 'super_admin'=>'Super Admin'],null,['class'=>'form-control input-sm'])}}
