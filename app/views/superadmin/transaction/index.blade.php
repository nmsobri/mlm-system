            ...
            <div class="widget-box">
                ...
                <div class="widget-title">
                    ...
                    @if( $transactions->count() > 0 )
                        ...
                        <div class="report">
                            {{html_entity_decode(HTML::link('/admin/super/report/transaction/excel', '<i class="fa fa-file-excel-o fa-lg"></i>'))}}
                            {{html_entity_decode(HTML::link('/admin/super/report/transaction/pdf', '<i class="fa fa-file-pdf-o fa-lg"></i>'))}}
                        </div>
                            ...
                            <tbody>
                                ...
                                @foreach($transactions as $transaction)
                                    ...
                                    <tr>
                                        ...
                                        <td> @if( in_array( $transaction->status, ['rejected', 'approved'] ) )Process this request @else<a href="{{url('/admin/super/transaction/process', $transaction->id)}}">Process this request</a> @endif</td>
                                    </tr>
