        ...
        <div class="col-xs-12">
            ...
            <div class="widget-box">
                ...
                <div class="widget-content">
                    ...
                    <p><a href="{{url('user/ultimate/account/payment')}}">Request Payout</a></p>
                ...
                <div class="widget-title">
                    ...
                    <h5>User Transaction</h5>
                        ...
                        @if( $transactions->count() > 0 )
                            ...
                            <div class="report">
                                {{html_entity_decode(HTML::link('/user/ultimate/report/transaction/excel', '<i class="fa fa-file-excel-o fa-lg"></i>'))}}
                                {{html_entity_decode(HTML::link('/user/ultimate/report/transaction/pdf', '<i class="fa fa-file-pdf-o fa-lg"></i>'))}}
                            </div>
