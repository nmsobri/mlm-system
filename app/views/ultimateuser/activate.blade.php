        ...
        <div class="col-xs-12">
            ...
            <div class="widget-box">
                ...
                <div class="widget-title">
                    ...
                    <h5>Activate Ultimate User</h5>
                </div>

                <div class="widget-content nopadding">

                    {{Form::open( ['url' => '/user/ultimate/activate', 'files' => true, 'class'=>'form-horizontal'] )}}

                        <div class="form-group">
                            <div class="col-sm-3 col-md-3 col-lg-2 visible-xs" style="text-align: center">
                                <img src="{{ asset('/img/' . Config::get('mlm.default_picture')) }}" class="img-thumbnail img-responsive" width="150" height="150"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group{{$errors->has('password_confirm') ? ' has-error' : ''}}">
                            {{Form::label('password_confirm','Passsword Confirm',['class'=>'col-sm-3 col-md-3 col-lg-2 control-label'])}}
