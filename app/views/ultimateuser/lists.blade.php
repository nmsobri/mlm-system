        ...
        <div class="col-xs-12">
            ...
            <div class="widget-box">
                ...
                <div class="widget-title">
                    ...
                    <h5>User List</h5>
                    <div class="report">
                        {{html_entity_decode(HTML::link('/user/ultimate/report/user/excel', '<i class="fa fa-file-excel-o fa-lg"></i>'))}}
                        {{html_entity_decode(HTML::link('/user/ultimate/report/user/pdf', '<i class="fa fa-file-pdf-o fa-lg"></i>'))}}
                    </div>
                </div>
